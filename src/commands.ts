export type CommandScope = "Global" | "View" | "Pull request" | "Workspace" | "Issues" | "Epics" | "Diff" | "Comments" | "Navigation" | "System"

const SCOPE_ORDER: readonly CommandScope[] = ["Global", "View", "Pull request", "Workspace", "Issues", "Epics", "Diff", "Comments", "Navigation", "System"]
